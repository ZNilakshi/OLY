...
import { FaRecycle, FaLeaf,  FaHeart } from 'react-icons/fa';
    ...
    <div key={index} className="bg-white rounded-lg shadow-md hover:shadow-xl transition duration-300 overflow-hidden flex flex-col md:flex-row">
      ...
      <div className="md:w-2/3 p-6 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-end border-t pt-4">
          <a href="https://linkedin.com/in/usernam" className="text-gray-400 hover:text-blue-600 transition-colors flex items-center">
